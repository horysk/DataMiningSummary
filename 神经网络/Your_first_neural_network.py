...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # as shown below.
        self.activation_function = lambda x : 1 / (np.exp(-x) + 1)  # Replace 0 with your sigmoid calculation.
...
class TestMethods(unittest.TestCase):
    ...
    def test_train(self):
        ...
        print("weights_input_to_hidden:", network.weights_input_to_hidden)
...
for ii in range(iterations):
    ...
    sys.stdout.write("\rProgress: {:2.1f}".format(100 * ii/float(iterations))                      + "% ... Training loss: " + str(train_loss)[:5]                      + " ... Validation loss: " + str(val_loss)[:5]                      + " ... Iterations times: " + str(ii))
    sys.stdout.flush()
